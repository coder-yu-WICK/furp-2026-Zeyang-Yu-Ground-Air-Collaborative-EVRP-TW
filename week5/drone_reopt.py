...
import math
import copy
from drone_post_processing import insert_cross_route_drones, apply_drone_postprocessing
...
def evaluate_drone_fleet_size(truck_routes, instance, max_drones_per_truck=3,
    ...
    for k in range(1, max_drones_per_truck + 1):
        ...
        new_routes, all_missions, saved, n_drones = insert_cross_route_drones(
