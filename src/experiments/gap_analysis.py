...
from src.config import (TRUCK_SPEED, TRUCK_CAPACITY, DEPOT,
                     TRUCK_DIST_COST_RATE, TRUCK_FIXED_COST)
from src.core.data_loader import load_instance_from_disk, build_instance
...
def make_small_instance(source_inst, n_cust):
    ...
    from src.core.data_loader import compute_distance_matrix
