...
FIGS_DIR = os.path.join(_BASE, '..', 'figures')
...
def create_poster():
    ...
    ax.text(L1+0.01, 0.505, 'Solomon VRPTW: 6 types x 3 scales (50/100/200c)',
    ...
    lit_text = (
        ...
        '- E-VRP (Schneider et al. 2014; Keskin & Catay 2016): EV battery\n'
    ...
    # Mini table
    table_data = [
        ['Instance', 'Ours-2D', 'CW-Sav', 'DroneD%', 'Feas%'],
    ...
    ev_table = [
        ['Battery',  'DCost(B-A)', 'DCost(C-B)', 'CS/Inst', 'EV-Feas'],
    ...
    failures = [
        ...
        ('2. TW Tightening', 'Scale due_times x50% -> tardiness 850+'),
