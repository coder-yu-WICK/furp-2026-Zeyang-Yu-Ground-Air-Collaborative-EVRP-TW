...
def load_instance(name):
    """Load a Solomon instance from data/."""
...
def get_routes(instance, n_trucks, max_drones_per_truck, seed=42,
    ...
    """
    from week8.pipeline.pipeline import solve_with_repair
...
def get_ev_routes(instance, n_trucks, battery_capacity=30.0,
    ...
    from week8.ev.ev_model import (
        insert_charging_stops, simulate_route_ev, EVTruckSolution
    )
    ...
    from week8.config import CHARGING_STATIONS, BATTERY_CAPACITY
    import numpy as np
...
def generate_all_route_maps():
    ...
    """
    from week8.config import CHARGING_STATIONS
...
def generate_panel_figure():
    """
    Generate a 2x2 panel figure comparing route structures across instance types.
    Panel layout:
    ...
    print('\n' + '=' * 60)
    print('GENERATING 2x2 PANEL FIGURE')
    print('=' * 60)
