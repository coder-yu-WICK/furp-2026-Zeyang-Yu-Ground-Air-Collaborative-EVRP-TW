# -*- coding: utf-8 -*-
"""
IVND: Improved Variable Neighborhood Descent for Truck-Only Routing.
Based on DOI: 10.1109/TITS.2022.3181282

Key features:
  - K-means clustering + Nearest Neighbor initial solution
  - 3 neighborhood structures for truck routes
...
class IVNDSolver:
    ...
    def _apply_neighborhood(self, name, routes, missions):
        """Apply a specific neighborhood structure (truck-only)."""
        methods = {
    ...
    def solve(self):
        ...
        for restart in range(3):  # Multiple restarts for diversity
            ...
            current_sol = TruckSolution(routes, self.instance)
            ...
            for self.iteration in range(self.max_iter // 3):
                ...
                while k <= self.shaking_k_max and not improved:
                    ...
                    new_sol = TruckSolution(r_shake, self.instance)
