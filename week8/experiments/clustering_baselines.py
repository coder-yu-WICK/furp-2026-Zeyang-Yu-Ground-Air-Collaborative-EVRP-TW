...
def clarke_wright_savings(instance, n_trucks, seed=42):
    ...
    Returns:
        TruckSolution (truck-only, no drones)
    """
    random.seed(seed)
    customers = instance['customers']
    depot = instance['depot']
    ...
    return TruckSolution(unique_routes, instance)
...
def kmeans_nearest_neighbor(instance, n_trucks, seed=42):
    ...
    from week8.algorithms.pomo_multi_truck import cluster_customers
...
def sweep_pomo(instance, n_trucks, model_path=None, seed=42):
    ...
    Returns:
        TruckSolution
    """
    from week8.pipeline.pomo_solver import ImprovedPOMOSolver
