...
Usage:
    ...
    python -m algorithms.pomo.train --pretrained --epochs 50

    # Train from scratch (slower, ~6-12 hours)
    python -m algorithms.pomo.train --epochs 100

    # CPU training
    python -m algorithms.pomo.train --device cpu --epochs 30

    # Quick test
    python -m algorithms.pomo.train --epochs 5 --episodes-per-epoch 50
"""
...
_pomo_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
from config import TRUCK_SPEED, BATTERY_CAPACITY
